      ...
      <div className="championship-content">
        ...
        <div className="text-section">
          ...
          <p>
            ...
            around the globe: From the action-packed 24 Hours of Le Mans, to the
            intense battle across Europe, Asia, North and South America and the
            Middle East. Every race is a new challenge for the Porsche 963. Join
            us, as we push our limits, chase titles, and continue the Porsche
